<!--多对一-->
<resultMap id="select${uppercaseEnity}With${oneEntityUpper}RM" type="com.xiexin.bean.${uppercaseEnity}" extends="BaseResultMap">
    <association property="${oneEntityLower}" javaType="com.xiexin.bean.${oneEntityUpper}">
           拷贝...........................  1 的 1 方
    </association>
</resultMap>
<select id="select${uppercaseEnity}With${oneEntityUpper}" resultMap="select${uppercaseEnity}With${oneEntityUpper}RM" parameterType="com.xiexin.bean.${uppercaseEnity}">
