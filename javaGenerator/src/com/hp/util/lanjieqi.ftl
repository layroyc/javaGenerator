...
这里写登录的那个类 loginUser = (这里写登录的那个类) session.getAttribute("loginUser");
// 2. 判断 这个 loginUser 是否为空
if (loginUser != null) {
return true; // 放行
}
// 重定向到  登录页
httpServletRequest.getRequestDispatcher("/login_ui").forward(httpServletRequest, httpServletResponse);
return false;  // 拦截
}
...
//        			<!--拦截器的类-->
//         			<bean class="com.hp.intecepter.LoginIntercepteor" />
//         		</mvc:interceptor>
//     	</mvc:interceptors>
