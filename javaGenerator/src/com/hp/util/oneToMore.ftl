...
-->
<resultMap id="select${uppercaseEnity}And${moreEntityUpper}RM" type="com.hp.bean.${uppercaseEnity}" extends="BaseResultMap">
    <collection property="${moreEntityLower}List" ofType="com.hp.bean.${moreEntityUpper}">
        <!-- 自己拷贝多方的  头过来  -->
    </collection>
</resultMap>
<select id="select${uppercaseEnity}And${moreEntityUpper}" resultMap="select${uppercaseEnity}And${moreEntityUpper}RM" parameterType="com.hp.bean.${uppercaseEnity}">
